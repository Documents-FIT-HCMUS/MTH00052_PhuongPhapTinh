...
VT = [ 1, 0, 0, 0, 0, 0, 0;
        h(1)/6, (h(1)+h(2))/3, h(2)/6, 0, 0, 0, 0;
        0, h(2)/6, (h(2)+h(3))/3, h(3)/6, 0, 0, 0;
        0, 0, h(3)/6, (h(3)+h(4))/3, h(4)/6, 0, 0;
        0, 0, 0, h(4)/6, (h(4)+h(5))/3, h(5)/6, 0;
        0, 0, 0, 0, h(5)/6, (h(5)+h(6))/3, h(6)/6;
        0, 0, 0, 0, 0, 0, 1 ]
VP = [ 0; 
    (yy(3)-yy(2))/h(2) - (yy(2)-yy(1))/h(1); 
    (yy(4)-yy(3))/h(3) - (yy(3)-yy(2))/h(2);
    (yy(5)-yy(4))/h(4) - (yy(4)-yy(2))/h(3);
    (yy(6)-yy(5))/h(5) - (yy(5)-yy(4))/h(4);
    (yy(7)-yy(6))/h(6) - (yy(6)-yy(5))/h(5);
    0 ];
m = inv(VT)*VP;
